...
mod tests {
    ...
    fn test_hash_compatibility_with_client() {
        ...
        assert_eq!(body_hash, "f7eb7961d8a233e6256d3a6257548bbb9293c3a08fb3574c88c7d6b429dbb9f5");
        assert_eq!(chain_hash, "e8910954652f2957dd5b6f34d88c78ff7f086546e2b94aef687290d409519a67");
    }
    ...
    fn test_hello_tributary() {
        ...
        assert_eq!(body_hash, "692f392e53f691be69dd1e502ef474a9103a19a48ef7a0a9115ee83d3a4bcb57");
        assert_eq!(chain_hash, "c6a7678f0c10c4ef797589575b0c8ffc108ee965cf1c06fef71cec3edc867b91");
    }
    ...
    fn test_chain_hash_without_prior() {
        ...
        assert_eq!(body_hash, "7749435cc893289da9df793cdb29ba90e082e57e6a60f4019b1d22f57bc3bf40");
        assert_eq!(chain_hash, "f962b7ec0d0375d2ee951857e1209bd1c6f70b26626face9c948569718503641");
    }
    ...
    fn test_chain_hash_with_real_prior() {
        ...
        assert_eq!(body_hash, "f5f5fd73d02a1535460e64279b2aa672309c80b129f28efe2ab523f32d1e91be");
        assert_eq!(chain_hash, "b17d1dcc5867c9dbaf798b1d7cd91168a362702d4acfd0f8f997c7390aaf65f9");
    }
}
